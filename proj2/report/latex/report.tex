...
The Breast Cancer dataset was also obtained from the UCI repository \cite{cancer}.

\section{Musk Dataset}

Finally, the Musk data was also obtained from the UCI repository \cite{musk}.
...
-Spikes in errors are because of poor training subsets (not enough info, outliers being chosen, etc.)
-Error threshold is 5\%
-Weighted majority voting
-Dataset info
-Adaboost always did better than a single classifier at one point or another
